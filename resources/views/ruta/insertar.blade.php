...
<div class="card">
    <div class="card-body">
        ...
        <h4 class="header-title">REGISTRAR NUEVA RUTA</h4>
        ...
        <form method="post" action="{{route('ruta.store')}}">
            ...
            <div class="form-group">
                ...
                <input value="{{old('longitud')}}" type="number" class="form-control" id="longitud"  name="longitud" aria-describedby="emailHelp" placeholder="Ingrese longitud">
                {{-- para mostrar errores --}}
                {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your
                    email with anyone else.</small> --}}
                    @error('longitud')
