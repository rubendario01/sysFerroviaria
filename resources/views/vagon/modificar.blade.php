...
<div class="card">
    <div class="card-body">
        ...
        <h4 class="header-title">MODIFICAR VAGON</h4>
        <form method="post" action="{{route('vagon.update', $vagon->id)}}">
            @csrf
            @method('put')
            <div class="form-group">
                <label for="">Nro</label>
                <input value="{{old('nro_vagon', $vagon->nro_vagon)}}" type="number" class="form-control" id="nro_vagon" name="nro_vagon" aria-describedby="emailHelp"
            ...
            <div class="form-group">
                ...
                <textarea rows='3' class="form-control" id="descripcion" name="descripcion" aria-describedby="emailHelp"
                    placeholder="Ingrese descripcion">{{old('descripcion', $vagon->descripcion)}}</textarea>
                {{-- para mostrar errores --}}
                {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your
                    email with anyone else.</small> --}}
            </div>
            ...
            <div class="form-group">
                ...
                <input value="{{old('capacidad', $vagon->capacidad)}}" type="number" class="form-control" id="capacidad" name="capacidad" aria-describedby="emailHelp"
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <input value="{{old('tren', $vagon->tren['nombre'])}}" type="text" name="tren" id="tren" class="form-control" placeholder="tren...">
                        <input type="hidden" id="id_tren" name="tren_id" value="{{old('tren_id', $vagon->tren_id)}}">
                    </div>
                    <div class="col-md-2">
