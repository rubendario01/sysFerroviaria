@extends('templates.content-horizontal')

@section('content')

<div class="col-md-7 card m-2">
    <h3 class="text-start m-2">ENCUENTRE SU VIAJE</h3>
    <div class="input-group mb-3">

        <input type="text" class="form-control" placeholder="¿En donde inicia su viaje?">
        <input type="text" class="form-control" placeholder="¿Hacia donde viajará?">
    ...
    <br>
    <label for="">Viajes Disponibles</label>
            ...
            <table class="table text-center">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>DDBHB122</td>
                        <td>
                            <a href="" id="" class="btn btn-success btn-xs btnAsientos">
                                <i class="fa fa-bus"></i> 
                            </a>
...
<div class="col p-0 m-0">
    ...
    <div class="card m-2 pl-2 pr-2">
        ...
        <h3 class="text-center m-2">RESERVA</h3>
        ...
        <div class="form-group m-2 mb-3">
            ...
            <input type="number" name="" id="" class="form-control " placeholder="Ejem. 754884848">
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Asientos Disponibles</h5>
            ...
            <div class="modal-body bg-light">
                ...
                <div class="row m-1">
                    ...
                    <div class="col-md-2">
                        <div class="card border bg-danger" style="height:50px">
                            <div class="d-flex justify-content-center" style="width:100%; height:60%">
                                <h4>2</h4>
                            </div>
                            <div class="d-flex justify-content-center" style="width:100%; height:40%">
                    ...
                    <div class="col-md-2">
                        <div class="card border bg-warning" style="height:50px">
                            <div class="d-flex justify-content-center" style="width:100%; height:60%">
                                <h4>4</h4>
                            </div>
                            <div class="d-flex justify-content-center" style="width:100%; height:40%">
                ...
                <div class="row m-1">
                    <div class="col-md-2">
                        <div class="card border" style="height:50px">
                            <div class="d-flex justify-content-center" style="width:100%; height:60%">
                                <h4>7</h4>
                            </div>
                            <div class="d-flex justify-content-center" style="width:100%; height:40%">
